...
Kaiseki.prototype = {
  ...
  getCurrentUser: function(callback, sessionToken) {
    this._jsonRequest({
      url: '/1/users/me',
      callback: callback,
  ...
  _jsonRequest: function(opts) {
    ...
    if (this.sessionToken || opts.sessionToken)
      reqOpts.headers['X-Parse-Session-Token'] = opts.sessionToken || this.sessionToken;
    if (this.masterKey)
