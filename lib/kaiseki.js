...
var Kaiseki = function(applicationId, restAPIKey, sessionToken, serverUrl) {
  this.applicationId = applicationId;
  this.restAPIKey = restAPIKey;
  this.masterKey = null;
  this.sessionToken = _.isUndefined(sessionToken) ? null : sessionToken;
  this.serverUrl = _.isUndefined(serverUrl)? DEFAULT_SERVER_URL : serverUrl;
  this.mountPath = _.isUndefined(serverUrl)? DEFAULT_MOUNT_PATH : '/parse';
  //parse open source api server is required revocable session,
  //origin parse server is optional, after March 25 2015, default is true
  this.revocable = 1;
};

var DEFAULT_MOUNT_PATH = '/1';
var DEFAULT_SERVER_URL = 'https://api.parse.com' + DEFAULT_MOUNT_PATH;
...
Kaiseki.prototype = {
  ...
  _jsonRequest: function(opts) {
    ...
    request(this.serverUrl + opts.url, reqOpts, function(err, res, body) {
